...
function Form() {
    ...
    return (
        <div  className="w-screen h-screen bg-gradient-to-r from-cyan-500 to-blue-500 flex flex-col items-center">
            ...
            <div className='mt-60 md:h-28 md:w-96 h-28 w-72 rounded-xl bg-white flex justify-center   shadow-2xl shadow-slate-600'>
                <div className='mt-4'>
                    ...
                    <form onSubmit={update.action ? (e)=> handleDataupdate(e, update.id) : (e) => handleSubmit(e)}>
                        ...
                        <input type="text" placeholder='type here . . .' className=' md:w-60 md:h-9 w-40 h-9 mt-2 border-2 rounded-md border-slate-400 placeholder-slate-300 px-2 py-1' onChange={handleChange} value={input}/>
